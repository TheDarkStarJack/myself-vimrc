...
vim.api.nvim_create_user_command("ToggleTermSendCurrentLineNoTrimWs", function(opts)
  require("toggleterm").send_lines_to_terminal("single_line", false, opts)
end, { nargs = "?", force = true })
vim.api.nvim_create_user_command("ToggleTermSendVisualLinesNoTrimWs", function(opts)
  require("toggleterm").send_lines_to_terminal("visual_lines", false, opts)
end, { range = true, nargs = "?", force = true })
vim.api.nvim_create_user_command("ToggleTermSendVisualSelectionNoTrimWs", function(opts)
  require("toggleterm").send_lines_to_terminal("visual_selection", false, opts)
end, { range = true, nargs = "?", force = true })
